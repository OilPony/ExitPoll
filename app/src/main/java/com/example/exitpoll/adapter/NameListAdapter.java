...
public class NameListAdapter extends ArrayAdapter<PollItem> {
    ...
    public NameListAdapter(@NonNull Context context,
                           int resource,
                           @NonNull List<PollItem> nameItemList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        PollItem nameItem = mNameItemList.get(position);
        String title =nameItem.number;
